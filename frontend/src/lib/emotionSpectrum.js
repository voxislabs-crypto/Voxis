...
const ZONES = {
	green: {
		...
		surface: "linear-gradient(135deg, rgba(7, 65, 42, 0.82), rgba(10, 44, 32, 0.9))",
	},
	yellow: {
		key: "yellow",
		label: "Yellow Zone",
		...
		surface: "linear-gradient(135deg, rgba(92, 64, 7, 0.8), rgba(44, 34, 9, 0.9))",
	},
	red: {
		key: "red",
		label: "Red Zone",
		...
		surface: "linear-gradient(135deg, rgba(90, 11, 30, 0.82), rgba(45, 10, 20, 0.92))",
	},
	blue: {
		key: "blue",
		label: "Blue Zone",
		...
		surface: "linear-gradient(135deg, rgba(10, 42, 95, 0.82), rgba(8, 24, 52, 0.92))",
	},
};
